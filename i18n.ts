...
const translations = {
  zh: {
    ...
    "settings.speedUnit.desc": "选择平均速度按每小时或每分钟显示。",
    "settings.speedUnit.name": "速度显示单位",
    "settings.title": "写作统计设置",
    "speedMode.total": "总计速度",
    "speedMode.writing": "码字速度",
    "speedUnit.hour": "每小时",
    "speedUnit.minute": "每分钟",
    "time.seconds": "秒",
    "units.character": "字",
  ...
  en: {
    ...
    "settings.speedUnit.desc": "Choose whether average speed is displayed per hour or per minute.",
    "settings.speedUnit.name": "Speed display unit",
    "settings.title": "Writing stats settings",
    "speedMode.total": "Total speed",
    "speedMode.writing": "Writing speed",
    "speedUnit.hour": "Per hour",
    "speedUnit.minute": "Per minute",
    "time.seconds": "sec",
